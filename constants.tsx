...
export const TESTIMONIALS: Testimonial[] = [
  {
    ...
    content: 'SalesforceHuntAi transformed our sales process. Our team productivity increased by 40% within the first three months of implementation.',
...
export const FAQS: FAQItem[] = [
  // General (8)
  { category: 'General', question: 'What is SalesforceHuntAi?', answer: 'We are a premier Salesforce consulting partner specializing in AI-driven digital transformation, implementation, and custom development.' },
